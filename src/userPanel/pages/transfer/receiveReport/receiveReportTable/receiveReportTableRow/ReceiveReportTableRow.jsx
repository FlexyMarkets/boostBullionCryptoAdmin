...
import { receiveReportTableRowData } from './receiveReportTableRowData';

function ReceiveReportTableRow() {

  return (
    <>
      {
        receiveReportTableRowData.map((data, i) => (
          <TableRow key={i}>
...
export default ReceiveReportTableRow;