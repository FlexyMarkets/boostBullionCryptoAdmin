...
function TransferTLCTwoPointORedeemWalletForm() {
  ...
  return (
    <Stack mt={"2rem"}>
      <Container>
        ...
        >
          <Typography mx={{ xs: "1rem", md: "0" }}>Transfer Fund (TLC 2.0 Redeem Wallet to Package Wallet)</Typography>
          <Divider sx={{ my: "1.2rem" }} />
          <Grid container size={12} spacing={3}>
            <Grid item size={{ xs: 12, sm: 6 }}>
              <InputLabel sx={{ mb: ".5rem" }}>TLC</InputLabel>
              <TextField fullWidth placeholder="Enter TLC" variant="outlined" />
            </Grid>
            <Grid item size={{ xs: 12, sm: 6 }}>
...
export default TransferTLCTwoPointORedeemWalletForm;