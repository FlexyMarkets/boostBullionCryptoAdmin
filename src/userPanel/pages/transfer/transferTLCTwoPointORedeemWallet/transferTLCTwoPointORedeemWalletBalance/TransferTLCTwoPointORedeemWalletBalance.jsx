...
import { transferTLCTwoPointORedeemWalletBalanceData } from "./transferTLCTwoPointORedeemWalletBalanceData"


function TransferTLCTwoPointORedeemWalletBalance() {
  return (
    <Stack mt={"2rem"}>
      <Container>
        <Grid container size={12} spacing={4}>
          {
            transferTLCTwoPointORedeemWalletBalanceData.map((data, i) => (
...
export default TransferTLCTwoPointORedeemWalletBalance;