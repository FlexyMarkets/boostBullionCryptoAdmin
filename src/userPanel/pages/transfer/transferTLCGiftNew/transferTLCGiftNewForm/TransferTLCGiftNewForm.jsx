...
function TransferTLCGiftNewForm() {
  ...
  return (
    <Stack mt={"2rem"}>
      <Container>
        ...
        >
          <Typography mx={{ xs: "1rem", md: "0" }}>Transfer Fund (Gift TLC New Wallet to Package Wallet)</Typography>
...
export default TransferTLCGiftNewForm;