...
import { transferTLCGiftNewWalletData } from "./transferTLCGiftNewWalletData"


function TransferTLCGiftNewWallet() {
  return (
    <Stack mt={"2rem"}>
      <Container>
        <Grid container size={12} spacing={4}>
          {
            transferTLCGiftNewWalletData.map((data, i) => (
...
export default TransferTLCGiftNewWallet;