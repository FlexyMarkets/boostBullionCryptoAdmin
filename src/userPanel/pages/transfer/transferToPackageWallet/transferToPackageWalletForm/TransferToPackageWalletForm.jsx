...
function TransferToPackageWalletForm() {
    ...
    return (
        <Stack mt={"2rem"}>
            <Container>
                ...
                >
                    <Typography mx={{ xs: "1rem", md: "0" }}>Transfer Fund to Package Wallet</Typography>
                    <Divider sx={{ my: "1.2rem" }} />
                    <Grid container size={12} spacing={3}>
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>Select Wallet</InputLabel>
                            <Selector items={["Income Wallet", "Package Wallet", "TLC Income Wallet", "TLC Package Wallet"]} shouldBeFullWidth={true} />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>Transfer To (User ID)</InputLabel>
                            <TextField fullWidth placeholder="Enter amount" variant="outlined" />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>Amount to be Transfer</InputLabel>
                            <TextField fullWidth placeholder="Enter MT5 Account No" variant="outlined" />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
...
export default TransferToPackageWalletForm;