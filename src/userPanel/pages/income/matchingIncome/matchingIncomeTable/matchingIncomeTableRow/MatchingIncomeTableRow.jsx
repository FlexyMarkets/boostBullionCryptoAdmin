...
import { matchingIncomeTableRowData } from './matchingIncomeTableRowData';

function MatchingIncomeTableRow() {

  return (
    <>
      {
        matchingIncomeTableRowData.map((data, i) => (
          <TableRow>
...
export default MatchingIncomeTableRow;