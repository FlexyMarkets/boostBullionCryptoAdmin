...
import { useReplaySupportTicketMutation, useSupportTicketByIdQuery } from "../../../../globalState/admin/adminStateApis";
        ...
        <Container sx={{ mt: "100px", display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            >
                {
                    (selectedTicket?.message)?.length > 0 && (selectedTicket?.message).map((item, i) => (
                        <Stack
                            sx={{
                                flexFlow: item?.sender === "admin" && "row-reverse",
                        ...
                        >
                            ...
                            >
                                <Typography sx={{ fontSize: "1rem", fontWeight: "bold" }}>{isLoading ? <Skeleton width={"200px"} /> : item?.sender === "admin" ? "You" : "User"}</Typography>
            ...
            >
                <Typography
                    ...
                    fontSize={"1.2rem"}
                    fontWeight={"bold"}
                    color={selectedTheme === "dark" ? "#699d89" : "#17433d"}
