...
const data = { walletHeading: "Wallet Balance", walletBalance: "$768.71", icon: <EqualizerIcon sx={{ fontSize: "5rem", color: "primary.main" }} /> }

function RenewalRobotWallet() {
  return (
    <Stack mt={"2rem"}>
      <Container>
        <Card
...
export default RenewalRobotWallet;