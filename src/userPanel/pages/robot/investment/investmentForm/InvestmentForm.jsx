import { Button, Card, Checkbox, Divider, Stack, Typography, TextField, InputLabel, OutlinedInput, IconButton, InputAdornment, useMediaQuery, Container } from '@mui/material'
            ...
            <Container>
                ...
                >
                    ...
                    <Grid container size={12} spacing={3}>
                        ...
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>Investment Amount</InputLabel>
                            <TextField fullWidth placeholder="Enter amount" variant="outlined" />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>MT5 Account No</InputLabel>
                            <TextField fullWidth placeholder="Enter MT5 Account No" variant="outlined" />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
                            <InputLabel sx={{ mb: ".5rem" }}>Trading Type</InputLabel>
                            <Selector items={["Trading"]} shouldBeFullWidth={true} />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6 }}>
