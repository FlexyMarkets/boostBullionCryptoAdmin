...
import { withdrawalTradingCRYPTOTableRowData } from './withdrawalTradingCRYPTOTableRowData';

function WithdrawalTradingCRYPTOTableRow() {

  return (
    <>
      {
        withdrawalTradingCRYPTOTableRowData.map((data, i) => (
          <TableRow key={i}>
...
export default WithdrawalTradingCRYPTOTableRow;