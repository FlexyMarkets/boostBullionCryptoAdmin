...
import { withdrawalReportTableRowData } from './withdrawalReportTableRowData';

function WithdrawalReportTableRow() {

  return (
    <>
      {
        withdrawalReportTableRowData.map((data, i) => (
          <TableRow key={i}>
...
export default WithdrawalReportTableRow;