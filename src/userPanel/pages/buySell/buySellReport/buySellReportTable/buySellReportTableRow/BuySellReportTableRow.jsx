...
import { buySellReportTableRowData } from './buySellReportTableRowData';

function BuySellReportTableRow() {

  return (
    <>
      {
        buySellReportTableRowData.map((data, i) => (
          <TableRow key={i}>
...
export default BuySellReportTableRow;