  ...
  return (
    <Stack mt={"2rem"}>
      <Container>
        ...
        >
          <Stack sx={{ flexDirection: "row", justifyContent: "space-between", mx: { xs: "1rem", md: "0" } }}>
            <Typography>Buy TLC</Typography>
            <Typography>1 TLC = 128 USD</Typography>
          </Stack>
